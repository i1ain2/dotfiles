...
This project uses two TODO files:

- **`TODO.md`** - Team-shared tasks (tracked in git)
- **`TODO.local.md`** - Personal tasks and experiments (gitignored)

Both use simple markdown checklists with priority markers (🔴 High, 🟡 Medium, ✅ Completed).

## How To Create Anki Cards
See: `~/.claude/instructions/anki.md`
...
**回答は日本語で、指示内容に基づいた文脈と形式で、段階的に詳細に出力せよ**
